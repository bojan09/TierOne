...
insert into public.curriculum_lessons (id, slug, title, track, xp, sort_order) values
  ...
  ('sc-py-01', 'basics', 'Python Basics', 'scripting', 55, 6007),
  ('sc-py-02', 'data-structures', 'Data Types & Structures', 'scripting', 60, 6008),
  ('sc-py-03', 'control-flow', 'Control Flow & Loops', 'scripting', 55, 6009),
  ('sc-py-04', 'functions-modules', 'Functions & Modules', 'scripting', 60, 6010),
  ('sc-py-05', 'files-errors', 'Files & Error Handling', 'scripting', 60, 6011),
  ('sc-py-06', 'automation', 'IT Automation with Python', 'scripting', 65, 6012)
